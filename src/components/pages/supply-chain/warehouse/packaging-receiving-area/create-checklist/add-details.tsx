...
import { checklistDetailsRequestSchema } from "./types";
...
const AddDetailsDialog = ({
  ...
  const {
    ...
    resolver: zodResolver(checklistDetailsRequestSchema),
    mode: "all",
  });
  ...
  const onSubmit = (data: any) => {
    try {
      ...
      const validatedData = checklistDetailsRequestSchema.parse({
        ...data,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          <DialogTitle>Add Material Information</DialogTitle>
        </DialogHeader>
        <div>
          <p>
