...
import AddDetailsDialog from "./add-details";
  ...
  return (
    <div>
      ...
      <div className="flex justify-between px-2 py-5">
        <span className="font-medium">Packaging Material Information</span>
      ...
      <div className="max-h-[500px] min-h-[400px] w-full space-y-4 overflow-y-auto">
        {fields.map((field, index) => {
          const detailsData: ChecklistDetailsDto = {
          ...
          return (
            <div key={field.id} className="relative">
              ...
              <Card className="space-y-4 p-5">
                ...
                <TableForData lists={[detailsData]} />
                {weights &&
                  weights.some(
