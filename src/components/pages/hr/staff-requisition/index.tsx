...
import { useLazyGetApiV1StaffRequisitionsQuery } from "@/lib/redux/api/openapi.generated";
...
const Page = () => {
  ...
  const [loadStaffRequisitions, { isLoading, data: result, isFetching }] =
    useLazyGetApiV1StaffRequisitionsQuery();

  useEffect(() => {
    loadStaffRequisitions({
      page,
      pageSize,
