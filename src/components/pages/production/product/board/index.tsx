  ...
  return (
    <div className="px-10">
      ...
      <div className="flex gap-2">
        ...
        <div className="size-10 border-t-4 border-indigo-500"></div>
        <div className="size-10 border-r-4 border-indigo-500"></div>
        <div className="size-10 border-b-4 border-indigo-500"></div>
        <div className="size-10 border-l-4 border-indigo-500"></div>
      </div>
