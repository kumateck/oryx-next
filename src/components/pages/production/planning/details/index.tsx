...
import { Bom, FinishedGoods, OutdatedBom, Packaging, Routing } from "./tabs";
      ...
      <StepWrapper className="w-full">
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <span className="font-Medium block text-3xl text-primary-500">
              {singleDetailed?.name}{" "}
            </span>
            <ul className="flex gap-2">
              <li>
                <div className="rounded-3xl border border-neutral-300 px-2 text-sm text-neutral-700">
              ...
              >
                <span
                  className={cn(
                    ...
                    {
                      "font-Bold border-primary-600 p-4 text-primary-500":
                        activeTab === tab,
                    },
                  )}
                >
