            ...
            <div>
              ...
              <ul className="flex flex-wrap gap-2">
                {approval?.approvalStages?.map((res, index) => (
                  <li key={index}>
                    <div className="whitespace-nowrap rounded-3xl border border-neutral-300 p-1 px-2 text-sm text-neutral-700 flex flex-col justify-center items-center">
                      <span className="text-neutral-500 text-xl font-semibold px-5">
