...
export const createProformaAttachment = z.object({
  attachments: imageValidationSchema,
});

export type CreateProformaAttachment = z.infer<typeof createProformaAttachment>;
export const CreateProformaAttachmentValidator = zodResolver(
