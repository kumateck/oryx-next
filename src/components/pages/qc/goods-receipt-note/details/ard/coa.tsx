...
import { cn } from "@/lib";
import { usePostApiV1FormGenerateCertificateByMaterialBatchIdMutation } from "@/lib/redux/api/openapi.generated";
...
const PreviewCoa = ({ isOpen, onClose, children, materialBatchId }: Props) => {
