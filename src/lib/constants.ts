...
export const routes = {
  ...
  planning: () => "/products",
  newPlanning: () => "products/create",
  viewPlanning: (id: string) => `products/${id}/details`,
  editPlanning: (id: string) => `/production/products/${id}/edit/bom`,
  editPlanningBom: () => `bom`,
  editPlanningInfo: () => `info`,
  editPlanningPackaging: () => `packaging`,
  editPlanningPackingStyle: () => `packing-style`,
